      ...
      <aside className="relative hidden overflow-hidden bg-brand lg:flex lg:flex-col lg:justify-between lg:p-12">
        ...
        <div className="relative z-10 max-w-md">
          ...
          <p className="mt-4 text-brand-ink/70">
            Browse verified-by-students hostels near Nile and Baze. Filter by price,
            room size, and distance from your gate.
          </p>
        </div>
        <p className="relative z-10 text-sm text-brand-ink/60">Nile University · Baze University · Abuja</p>
      </aside>
